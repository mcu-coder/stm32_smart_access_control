...
U32 addrShort4 = 0x0800C000 + 15 * 8; // 2
U32 addrShort5 = 0x0800C000 + 16 * 8; // 2
U32 addrShort6 = 0x0800C000 + 17 * 8; // 2
U32 addrShort7 = 0x0800C000 + 18 * 8; // 2
void W_Test(void)
{
    ...
    System_WriteInteriorFlash(addrShort2, (uint8_t *)&device_state_init.DoorPwd, sizeof(device_state_init.DoorPwd)); // 存入数据，函数内自动解锁，擦除，写入
    System_WriteInteriorFlash(addrShort3, (uint8_t *)&device_state_init.SetPwd, sizeof(device_state_init.SetPwd)); // 存入数据，函数内自动解锁，擦除，写入
	
		System_WriteInteriorFlash(addrShort4, (uint8_t *)&threshold_value_init.card1, sizeof(threshold_value_init.card1));
		System_WriteInteriorFlash(addrShort5, (uint8_t *)&threshold_value_init.card2, sizeof(threshold_value_init.card2));
		System_WriteInteriorFlash(addrShort6, (uint8_t *)&threshold_value_init.card3, sizeof(threshold_value_init.card3));
		System_WriteInteriorFlash(addrShort7, (uint8_t *)&threshold_value_init.card4, sizeof(threshold_value_init.card4));
...
void R_Test(void)
{
    ...
    System_ReadInteriorFlash(addrShort2, (uint8_t *)&device_state_init.DoorPwd, sizeof(device_state_init.DoorPwd)); // 存入数据，函数内自动解锁，擦除，写入
    System_ReadInteriorFlash(addrShort3, (uint8_t *)&device_state_init.SetPwd, sizeof(device_state_init.SetPwd)); // 存入数据，函数内自动解锁，擦除，写入
		System_ReadInteriorFlash(addrShort4, (uint8_t *)&threshold_value_init.card1, sizeof(threshold_value_init.card1));
		System_ReadInteriorFlash(addrShort5, (uint8_t *)&threshold_value_init.card2, sizeof(threshold_value_init.card2));
		System_ReadInteriorFlash(addrShort6, (uint8_t *)&threshold_value_init.card3, sizeof(threshold_value_init.card3));
		System_ReadInteriorFlash(addrShort7, (uint8_t *)&threshold_value_init.card4, sizeof(threshold_value_init.card4));
